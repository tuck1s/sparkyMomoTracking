...
local safedomains = { "mblox.sms.agg", "validator.messagesystems.com", "messagesystems.com", "sparkpost.com", "momo.signalsdemo.trymsys.net", "fbl.momo.signalsdemo.trymsys.net" }
